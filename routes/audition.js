...
router.delete("/delete/:id",auth.loggedMiddleware, auth.isAdmin, planningController.deleteAudition);
...
router.patch("/update/:id",auth.loggedMiddleware, auth.isAdmin, planningController.updateAudition);
/**
 * @swagger
 * /audition/:
 *   get:
...
router.get("/",auth.loggedMiddleware, auth.isAdmin, planningController.getAudition);
/**
 * @swagger
 * /audition/fetch/{id}:
 *   get:
...
router.get("/fetch/:id",auth.loggedMiddleware, auth.isAdmin, planningController.fetchAudition);
/**
 * @swagger
 * /audition/add:
 *   post:
 ...
 */
 ...
 router.post("/add",auth.loggedMiddleware, auth.isAdmin, planningController.addAudition);
